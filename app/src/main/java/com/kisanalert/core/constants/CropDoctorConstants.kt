...
object CropDoctorConstants {
    ...
    const val LOW_CONFIDENCE_ALERT_SOURCE: String = "KrishakSeva-Android"
    const val EXPERT_CONTACT_NAME: String = "Kisan Call Centre"
    const val EXPERT_CONTACT_ROLE: String = "Agricultural Extension Helpline"
    const val EXPERT_CONTACT_PHONE: String = "18001801551"
}
